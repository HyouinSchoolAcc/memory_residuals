...
Writes paper_a/xcorpus_numbers.tex with macros consumed by main.tex.
...
OUT = ROOT / "paper_a" / "xcorpus_numbers.tex"
...
def main() -> None:
    lines: list[str] = []
    L = lines.append
    L("% Auto-generated by paper_a/scripts/compute_xcorpus_numbers.py")

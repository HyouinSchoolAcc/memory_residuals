#!/usr/bin/env bash
# v23a_v21c_seed1: multi-seed v21c reproducibility check.
...
OUT_DIR="output/chain_v23a_v21c_seed1_codes_0p6b_frozen_local"
LOG_DIR="logs"
mkdir -p "$LOG_DIR"
...
CUDA_VISIBLE_DEVICES=0 nohup python -u src/train_chain.py \
    ...
    --seed 1 \
    --run_name chain_v23a_v21c_seed1_codes_0p6b_frozen_local \
    --out_dir "$OUT_DIR" \
    > "$LOG_DIR/chain_v23a_v21c_seed1_codes_0p6b_frozen_local.log" 2>&1 &
echo "v23a launched pid=$!"

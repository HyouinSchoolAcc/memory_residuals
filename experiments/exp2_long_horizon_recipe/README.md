...
| cell | script |
|------|--------|
| GATED (HEADLINE, local GPU 0) | [`scripts/train_v6_lme_gated_callback.sh`](../../scripts/train_v6_lme_gated_callback.sh) |
| COMPETITIVE (arch A/B, local GPU 1) | [`scripts/train_v6_ablation_a_competitive.sh`](../../scripts/train_v6_ablation_a_competitive.sh) |
| GATED-DEEP (depth ablation, GH200) | [`scripts/train_v6_lme_gated_w12_gh200.sh`](../../scripts/train_v6_lme_gated_w12_gh200.sh) |
...
python paper_tools/routing_trace.py --model_path output/<run_name>/best \
  --output paper_artifacts/eval/routing_<run_name>.json
python paper_tools/counterfactual_eval.py --model_path output/<run_name>/best \

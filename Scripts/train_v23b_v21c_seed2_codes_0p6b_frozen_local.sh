#!/usr/bin/env bash
# v23b_v21c_seed2: multi-seed v21c reproducibility check.
...
OUT_DIR="output/chain_v23b_v21c_seed2_codes_0p6b_frozen_local"
LOG_DIR="logs"
mkdir -p "$LOG_DIR"
...
CUDA_VISIBLE_DEVICES=1 nohup python -u src/train_chain.py \
    ...
    --seed 2 \
    --run_name chain_v23b_v21c_seed2_codes_0p6b_frozen_local \
    --out_dir "$OUT_DIR" \
    > "$LOG_DIR/chain_v23b_v21c_seed2_codes_0p6b_frozen_local.log" 2>&1 &
echo "v23b launched pid=$!"

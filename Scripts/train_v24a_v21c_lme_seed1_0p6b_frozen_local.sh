#!/usr/bin/env bash
# v24a: v21c recipe trained on LongMemEval (real-content data) instead
...
OUT_DIR="output/chain_v24a_v21c_lme_seed1_0p6b_frozen_local"
LOG_DIR="logs"
mkdir -p "$LOG_DIR"
...
CUDA_VISIBLE_DEVICES=0 nohup python -u src/train_chain.py \
    ...
    --seed 1 \
    --run_name chain_v24a_v21c_lme_seed1_0p6b_frozen_local \
    --out_dir "$OUT_DIR" \
    > "$LOG_DIR/chain_v24a_v21c_lme_seed1_0p6b_frozen_local.log" 2>&1 &
echo "v24a launched pid=$!"

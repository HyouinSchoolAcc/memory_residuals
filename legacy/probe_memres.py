"""
Memory Residual probe: measure alpha-mass routed to m^t (b_-1) per layer.
...
collect_alpha_trace=True and report mean alpha_{b_-1->l} (per routing layer)
...
def report(callback_traces, filler_traces):
    ...
    print("(positive Δ => model routes MORE mass to b_-1 memory on callback prompts)")
